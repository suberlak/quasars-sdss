...
pre = '../'
dir_choice=['QSO_try/', 'QSO_SDSS_analysis/']
dir_in = pre+dir_choice[1]

javelin_chains = 'javelin_SDSS_chain_results_g_band.txt' # CRTS :  javelin_chain_results_ALL_sigma_tau.txt'
...
# prepare storage for ra and dec 
...
def ra_dec_extract_CRTS():
    ...
    return dec_jav_split, dec_jav_split
...
output = 'javelin_chelsea_comparison_ALL.txt'
