...
def sf_plot_panels(qso_data,star_data_blue, star_data_red, sample, choice, 
    ...
    star_plot = get_plotted_quantities(star_data_blue, nbins, mu_sig_sample, mu_sig_generic)
    #return star_plot
    ...
    star_plot1 = get_plotted_quantities(star_data_red, nbins, mu_sig_sample, mu_sig_generic)
